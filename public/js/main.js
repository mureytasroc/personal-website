...
"use strict";
    ...
    $(document).on('ready', function() {
        ...
        var acc = document.getElementsByClassName("timeline-item");
        var i;
        for (i = 0; i < acc.length; i++) {
          acc[i].addEventListener("click", function() {
            ...
            var itemDescriptions = this.getElementsByClassName("item-description");
            var j;
            for (j = 0; j < itemDescriptions.length; j++) {
